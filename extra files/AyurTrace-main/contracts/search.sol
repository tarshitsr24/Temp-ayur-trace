...
contract AyuTraceSearch {
    ...
    function getBatchStatusString(AyuTrace.BatchStatus _status) public pure returns (string memory) {
        return ayuTraceContract.getBatchStatusString(_status);
    }

    function getProductStatusString(AyuTrace.ProductStatus _status) public pure returns (string memory) {
